  ...
  module PdfConstruction
    module HigherLevelReview::V3
      class Structure
        ...
        DEFAULT_FIELD_HEIGHT = 14.3
        DEFAULT_TEXT_HEIGHT = 13
        ...
        def form_fill
          options = {
            ...
            # Section V: Issues (allows 13 in fields)
            ...
            # Section VII: Authorized Rep Sig
            # NOT YET SUPPORTED
          }
        ...
        def form_fields
          @form_fields ||= HigherLevelReview::V3::FormFields.new
        end

        def form_data
          @form_data ||= HigherLevelReview::V3::FormData.new(higher_level_review)
        end
        ...
        def whiteout(pdf, at:, width:, height: DEFAULT_FIELD_HEIGHT)
        ...
        def fill_text(pdf, attr, long_text_override: nil, length_for_override: SHORT_EMAIL_LENGTH)
          ...
          text_opts = form_fields.boxes[attr].merge(default_text_opts).merge(height: DEFAULT_TEXT_HEIGHT)
