      ...
      module Pages
        class AdditionalIssues
          ...
          def short_email_length
            AppealsApi::PdfConstruction::HigherLevelReview::V3::Structure::SHORT_EMAIL_LENGTH
          end

          def max_issues_on_form
            AppealsApi::PdfConstruction::HigherLevelReview::V3::Structure::MAX_NUMBER_OF_ISSUES_ON_MAIN_FORM
          end
        end
      end
    end
