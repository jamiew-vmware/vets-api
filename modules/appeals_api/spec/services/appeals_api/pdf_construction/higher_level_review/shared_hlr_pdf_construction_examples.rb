...
shared_examples 'shared HLR v2 and v3 form fields examples' do
...
shared_examples 'shared HLR v2 and v3 form data examples' do
...
shared_examples 'shared HLR v2 and v3 structure examples' do
  let(:higher_level_review) { create(:extra_higher_level_review_v2) }
